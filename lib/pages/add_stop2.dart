...
class AddStop2 extends StatefulWidget {
  ...
  @override
  State<AddStop2> createState() => _AddStop2State();
}

class _AddStop2State extends State<AddStop2> {
...
class AddStop2Map extends StatefulWidget {
  ...
  @override
  State<AddStop2Map> createState() => _AddStop2MapState();
}

class _AddStop2MapState extends State<AddStop2Map> {
  Location location = Location();

  TextEditingController stop2Address = TextEditingController();
  TextEditingController stop2area = TextEditingController();
        ...
        children: <Widget>[
          ...
          Positioned(
              ...
              child: _isWidgetLoading
                  ...
                  : AddStop2ReverseGeoCodingTextFormField(
                      addstop1latitude: latLngCamera.latitude,
                      addstop1longitude: latLngCamera.longitude,
                      addstop1administrativeArea: stop2area,
                      stop1Address: stop2Address,
                    ))
        ],
      ),
...
class AddStop2VerifyAddressBottomSheet extends StatefulWidget {
  ...
  _AddStop2VerifyAddressBottomSheetState createState() =>
      _AddStop2VerifyAddressBottomSheetState();
}

class _AddStop2VerifyAddressBottomSheetState
    extends State<AddStop2VerifyAddressBottomSheet> {
  List<Model> list = [];
...
class _AddStop2ShowDetailsState extends State<AddStop2ShowDetails> {
...
class AddStop2ReverseGeoCodingTextFormField extends StatefulWidget {
  AddStop2ReverseGeoCodingTextFormField(
      {Key? key,
  ...
  @override
  _AddStop2ReverseGeoCodingTextFormFieldState createState() =>
      _AddStop2ReverseGeoCodingTextFormFieldState();
}

class _AddStop2ReverseGeoCodingTextFormFieldState
    extends State<AddStop2ReverseGeoCodingTextFormField> {
  @override
  void initState() {
    initialize();
    super.initState();
